...
export default function Dropdown({ value, options, onChange, label }) {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left z-50">
            ...
            <MenuItems
                transition
                className="absolute right-0 mt-2 w-40 origin-top-right rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 shadow-lg focus:outline-none z-50"
            >
                <div className="py-1">
                    {options.map(option => (
